...
patch(SaleOrderLineProductField.prototype, {
    ...
    _getContractConfiguratorContext() {
        return {
            ...
            default_recurring_invoicing_type: this.props.record.data.recurring_invoicing_type,
            ...
            default_contract_start_date_method: this.props.record.data.contract_start_date_method,
        };
    },
