...
class TestContractBase(common.SavepointCase):
    ...
    @classmethod
    def _create_global_contract_several_lines(cls):
        # Create a global recurrence contract with several lines
        cls.contract_global_multi = cls.env["contract.contract"].create(
            {
                "name": "Test Contract Global Multi",
                "partner_id": cls.partner.id,
                "pricelist_id": cls.partner.property_product_pricelist.id,
                "line_recurrence": False,
                "contract_type": "sale",
        ...
        with Form(cls.contract_global_multi) as contract_form:
